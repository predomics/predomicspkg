...
-   **Edi Prifti**: Edi is the creator and maintainer of the `predomics` approach and package since 2015. He has proposed the genetic algorithm approaches (`TerGa1` and `TerGa2`), the concept of the Family of Best Models, numerous visualization tools and lots of other cool ideas.
...
-   **Youcef Sklab**: Youcef has co-led with Edi a couple student projects in collaboration with the https://www.sup-galilee.univ-paris13.fr to build the R Shiny predomicsapp application.
-   **Gaspar Roy**: Gaspar has worked on 2023 on on evolved version of the `predomicsapp` R shiny application https://predomics.ummisco.ioit.
